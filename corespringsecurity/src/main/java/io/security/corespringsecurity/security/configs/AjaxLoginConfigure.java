...
extends AbstractAuthenticationFilterConfigurer<H, AjaxLoginConfigure<H>, AjaxLoginProcessingFilter>{
	...
	public void configure(H http) throws Exception {
		...
		SessionAuthenticationStrategy authenticationStrategy = http
				.getSharedObject(SessionAuthenticationStrategy.class)
				;
		if(authenticationStrategy != null) {
			getAuthenticationFilter().setSessionAuthenticationStrategy(authenticationStrategy);
		}
	...
	public AjaxLoginConfigure<H> setAuthenticationManager(AuthenticationManager authenticationManager){
